...
---@return table
function StateTransition.New(targetState: SMTypesMod.State, transitionCondition: SMTypesMod.Condition, transitionName: string?)
    local self = {}

    SMArgValidationMod.CheckArgumentTypes(
        {SMTypesMod.State, SMTypesMod.Condition, 'string'},
        {targetState, transitionCondition, transitionName}, 'New', 3)
